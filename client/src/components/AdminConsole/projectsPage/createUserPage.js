...
import { IconButton, Button, Typography, TextField, Grid, Box } from '@mui/material';
...
export default function CreateUser() {
    ...
    const handleSave = () => {
        const { firstName, email, number, gender, lastName, DOB, DOJ, CTC, employeeID, employeeType, Status,band,Location,Role,Designation,skill,ManagerName } = formData;
        let errors = {};
                ...
                <div className="UserDetails" style={{ display: 'flex', marginTop: '20px' }}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} lg={6} md={2} >
                            <Grid style={{ marginTop: '8px', marginBottom: '20px' }} sx={{ width: 300 }}>
                                <Autocomplete
                                    freeSolo
                                    label="Manager Name"
                                    name="Manager Name"
